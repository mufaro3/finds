 ...
 * @file collision.c
 *
 * @brief FINDS example of a spherical system rotating and expanding.
 *
...
int main()
{
    ...
    /* First, we generate a sphere with a swirl orientation */
    ...
    ori_opts.type = ORIENTATION_SWIRL_OUTWARD;
